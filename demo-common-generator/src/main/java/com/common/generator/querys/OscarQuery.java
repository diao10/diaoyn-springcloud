...
public class OscarQuery extends AbstractDbQuery {
    ...
    public String tablesSql() {
        return "SELECT * FROM (SELECT " +
                ...
                "b.COMMENTS " +
                "FROM USER_TABLES a " +
                "INNER JOIN USER_TAB_COMMENTS b ON (b.TABLE_TYPE = 'TABLE' AND a.TABLE_NAME = b.TABLE_NAME)) a WHERE " +
                "1=1 ";
    }
    ...
    public String tableFieldsSql(String schema, String tableName) {
        return "SELECT " +
                ...
                "LEFT JOIN(SELECT a.TABLE_NAME,b.COLUMN_NAME,a.CONSTRAINT_TYPE FROM USER_CONSTRAINTS a, " +
                "USER_IND_COLUMNS b " +
                "WHERE a.CONSTRAINT_TYPE = 'P' AND a.INDEX_NAME = b.INDEX_NAME) T3 ON (T1.TABLE_NAME = T3.TABLE_NAME " +
